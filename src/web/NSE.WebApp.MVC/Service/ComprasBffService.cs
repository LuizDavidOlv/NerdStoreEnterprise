...
namespace NSE.WebApp.MVC.Service
{
    ...
    public class ComprasBffService : Service, IComprasBffService
    {
        ...
        {
            var pedidoContent = SerializarConteudo(pedidoTransacao);
        ...
        public async Task<PedidoViewModel> ObterUltimoPedido()
        {
            ...
            return await DeserializarObjectResponse<PedidoViewModel>(response);
        }
        ...
        public async Task<IEnumerable<PedidoViewModel>> ObterListaPorClienteId()
        {
            ...
            return await DeserializarObjectResponse<IEnumerable<PedidoViewModel>>(response);
        }
